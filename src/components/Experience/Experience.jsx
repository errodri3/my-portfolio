    ...
    <div style={{ fontSize: '13px', color: '#4a6a90', lineHeight: '1.6' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontWeight: '700', fontSize: '12px' }}>Societies</div>
            <div style={{ fontSize: '11px', opacity: 0.7 }}>Women in Information Computer Science, Made with Love, Anteater Adventure Club, VenusHacks, HackAtUCI, UCI Digital Learning Lab</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
          {['Android development'].map(skill => (
            <span key={skill} style={{
              background: 'rgba(226, 194, 248, 0.82)',
              border: '1px solid rgba(255,255,255,0.7)',
              borderRadius: '20px',
              padding: '3px 10px',
              fontSize: '11px',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
          {['Figma', 'Adobe Illustrator', 'Adobe Photoshop', 'Canva'].map(skill => (
            <span key={skill} style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px' }}>
          {['AWS', 'Git/GitHub', 'RESTful APIs', 'OAuth'].map(skill => (
            <span key={skill} style={{
